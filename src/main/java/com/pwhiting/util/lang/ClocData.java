...
public class ClocData {
	...
	public Map<Language, LangStats> getLanguageStatsMutable() {
	 ...
	 * @return
	 */
	public ClocData imprint(final ClocData data) {
	...
	public LangStats getLangStats(final Language lang) {
		return this.getLanguageStatsMutable().containsKey(lang) ? this.getLanguageStatsMutable()
	...
	public static class Header {
		 ...
		 * @return
		 */
		public Header imprint(final Header header) {
